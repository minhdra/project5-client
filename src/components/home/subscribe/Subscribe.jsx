export default function Subscribe({classes}) {
  return (
    <>
      <div className={'bg-opacity-0 px-5 sm:px-16 py-12 md:py-14 xl:py-16 flex flex-col xl:flex-row justify-center xl:justify-between items-center rounded-lg bg-gray-200 lg:py-16 ' + classes}>
