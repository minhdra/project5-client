    ...
    <>
      <div className='mx-auto max-w-[1920px] px-4 md:px-8 2xl:px-16'>
        <div className='py-14 xl:py-20 px-0 2xl:max-w-screen-2xl xl:max-w-screen-xl mx-auto flex flex-col md:flex-row w-full'>
          <LeftCheckout user={user} showDialogDelivery={showDialogDelivery} setShowDialogDelivery={setShowDialogDelivery} handleUpdateCustomerInfo={handleUpdateCustomerInfo} total={total} />
