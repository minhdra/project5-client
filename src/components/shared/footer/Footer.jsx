              ...
              <ul className='text-xs lg:text-sm text-body flex flex-col space-y-3 lg:space-y-3.5'>
                ...
                <li className='flex items-baseline'>
                  ...
                  <a
                    ...
                    target='_blank'
                    rel='noreferrer'
                    href='https://twitter.com/MinhDra'
                  >
                    Twitter
                  </a>
                </li>
                <li className='flex items-baseline'>
                  ...
                  <a
                    ...
                    target='_blank'
                    rel='noreferrer'
                    href='https://www.facebook.com/leminh0111/'
                  >
                    Facebook
                  </a>
                </li>
                <li className='flex items-baseline'>
                  ...
                  <a
                    ...
                    target='_blank'
                    rel='noreferrer'
                    href='https://discord.com/users/5970'
                  >
                    Discord
                  </a>
                </li>
            ...
            <div className='pb-3 md:pb-0 undefined'>
              ...
              <ul className='text-xs lg:text-sm text-body flex flex-col space-y-3 lg:space-y-3.5'>
                ...
                <li className='flex items-baseline'>
                  <a
                    className='transition-colors duration-200 hover:text-black'
                    href='mailto:minhdra0111@gmail.com'
                  >
                    Email: minhdra0111@gmail.com
                  </a>
                </li>
                <li className='flex items-baseline'>
                  <a
